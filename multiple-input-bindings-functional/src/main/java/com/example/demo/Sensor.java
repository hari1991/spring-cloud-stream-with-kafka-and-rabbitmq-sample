...
public class Sensor extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static com.example.demo.Sensor.Builder newBuilder() {
    return new com.example.demo.Sensor.Builder();
  }
   ...
   * @return A new Sensor RecordBuilder
   */
  public static com.example.demo.Sensor.Builder newBuilder(com.example.demo.Sensor.Builder other) {
    if (other == null) {
      return new com.example.demo.Sensor.Builder();
    } else {
      return new com.example.demo.Sensor.Builder(other);
    }
  }
   ...
   * @return A new Sensor RecordBuilder
   */
  public static com.example.demo.Sensor.Builder newBuilder(com.example.demo.Sensor other) {
    if (other == null) {
      return new com.example.demo.Sensor.Builder();
    } else {
      return new com.example.demo.Sensor.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Sensor>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.demo.Sensor.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.demo.Sensor other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder setId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder setInternalTemperature(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder clearInternalTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder setExternalTemperature(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder clearExternalTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder setAcceleration(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder clearAcceleration() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder setVelocity(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.demo.Sensor.Builder clearVelocity() {
